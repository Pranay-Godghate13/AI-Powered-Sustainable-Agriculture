...
class Coordinator:
    ...
    def run_agent(self,farmer_advices, market_advices, financial_goals, crop_preferences):
        ...
        coordinator_agent=Agent(
            ...
            description = """You are a senior agricultural coordinator with 30+ years of experience
              in sustainable farming. Your role is to synthesize insights from the Farmer Advisor 
              and Market Researcher agents to provide clear, practical recommendations. Your goal 
              is to suggest crop choices that minimize water and chemical usage while helping the 
              farmer meet financial targets. Focus on sustainability, profitability, and resource 
              efficiency.""",
            instructions = [
                                        """
                                    1. **Understand the Inputs**:
                                    - Review data from Farmer Advisor and Market Researcher agents.
                                    - Focus on:
                                        - Crop preferences
                                        - Financial goals (profit, ROI, cost efficiency)
                                        - Environmental data (water availability, soil health, climate)

                                    2. **Re-rank the Crop Options**: ["Wheat", "Rice", "Soyabean", "Corn"]
                                    - Rank based on:
                                        - Water and chemical efficiency
                                        - Financial potential
                                        - Sustainability and environmental impact
                                    - Justify each crop’s position based on:
                                        - Water usage
                                        - Fertilizer/pesticide needs
                                        - Profitability
                                        - Fit with farmer’s resources

                                    3. **Match with Farmer Preferences**:
                                    - Check if top 2 ranked crops are among the farmer’s preferences.
                                    - If yes, proceed with detailed recommendations.
                                    - If not, suggest the best alternative and justify why it's superior.

                                    4. **Provide Actionable Recommendations**:
                                    For top 1 and 2 crops:
                                    - Suggested crop
                                    - Fertilizer usage
                                    - Pesticides usage
                                    ...
                                    - Advice on:
                                        ...
                                        - Chemical reduction
                                        - Market timing or positioning

                                    5. **Keep It Concise and Practical**:
                                    - No extra commentary
                                    - Prioritize clarity, usability, and actionability
                                    6. **No scientific name, give only english name**
                                    """
                                    ],
            markdown=True,
            ...
            *Actionable insights: - Fertilizer usage
                                    - Pesticides usage
                                    - Sustainability score
                                    - Expected yield
                                    - Profit estimate
